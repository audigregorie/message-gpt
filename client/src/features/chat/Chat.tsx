  ...
  return (
    <div className="flex flex-1 w-full h-full mt-16 gap-3">
      <div className="md:flex md:flex-[0.2] md:flex-col hidden ml-3">
        <div className="flex flex-col gap-6 h-[60vh] items-center justify-center bg-[rgb(17,29,39)] rounded-xl">
          ...
          <p className='font-["work sans"] text-center'>You can ask questions related to Knowledge Business, Advice, Education, and more.</p>
